    ...
    return struct {
        ...
        fn merge_callback(next_tick: *Grid.NextTick) void {
            ...
            inline for (.{
                ...
                compaction.table_builder.value_count,
            }) |value_count| {
                assert(value_count <= Table.data.value_count_max);
            }
            ...
            assert(compaction.quotas.done <= compaction.quotas.beat + Table.data.value_count_max);
